...
static GPIO_DriverGPIOConfig_s GPIO_DriverGPIOPeripherals[GPIO_DriverGPIOPeripheral_End] =
    {
        [GPIO_DriverGPIOLed1_o] = {.GPIO_Pin_Port = 0, .GPIO_Pin_Number = LED1_GPIO, .GPIO_Mode = GPIO_DriverGPIO_MODE_OUTPUT, .GPIO_PullUpDown_Selector = GPIO_DriverGPIO_FLOATING},
        [GPIO_DriverGPIOLed2_o] = {.GPIO_Pin_Port = 0, .GPIO_Pin_Number = LED2_GPIO, .GPIO_Mode = GPIO_DriverGPIO_MODE_OUTPUT, .GPIO_PullUpDown_Selector = GPIO_DriverGPIO_FLOATING},
        [GPIO_DriverGPIOButton1_i] = {.GPIO_Pin_Port = 0, .GPIO_Pin_Number = BUTTON1_GPIO, .GPIO_Mode = GPIO_DriverGPIO_MODE_INPUT, .GPIO_PullUpDown_Selector = GPIO_DriverGPIO_PULLUP_ONLY},
        [GPIO_DriverGPIOButton2_i] = {.GPIO_Pin_Port = 0, .GPIO_Pin_Number = BUTTON2_GPIO, .GPIO_Mode = GPIO_DriverGPIO_MODE_INPUT, .GPIO_PullUpDown_Selector = GPIO_DriverGPIO_PULLUP_ONLY}};
